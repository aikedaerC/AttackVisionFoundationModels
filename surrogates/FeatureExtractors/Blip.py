...
class BlipFeatureExtractor(BaseFeatureExtractor):
    def __init__(self):
        ...
        self.processor = BlipImageProcessor.from_pretrained("/root/autodl-tmp/cache/huggingface/hub/models--Salesforce--blip2-opt-2.7b/snapshots/51572668da0eb669e01a189dc22abe6088589a24")
        self.model = Blip2Model.from_pretrained("/root/autodl-tmp/cache/huggingface/hub/models--Salesforce--blip2-opt-2.7b/snapshots/51572668da0eb669e01a189dc22abe6088589a24")
